...
export const accessRateLimiter = createRateLimiter({
...
export const userSpecificRateLimiter = createUserRateLimiter(
  (req: Request) => {
...
export const roleBasedRateLimiter = (req: Request, res: Response, next: any) => {
  if (!req.user) {
