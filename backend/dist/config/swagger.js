...
const setupSwagger = (app, apiPrefix) => {
    try {
        // Serve Swagger UI
        app.use(`/${apiPrefix}/docs`, swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(swaggerDocument, swaggerOptions));
        // Serve Swagger JSON
        app.get(`/${apiPrefix}/docs.json`, (req, res) => {
            res.setHeader('Content-Type', 'application/json');
            res.send(swaggerDocument);
        });
        logger_1.logger.info(`📚 Swagger documentation available at /${apiPrefix}/docs`);
    }
    catch (error) {
